...
const display = (arr) =>
  arr.forEach((element) => (element.style.display = "block"));
const hide = (arr) =>
...
const productCardCreator = (
  ...
  for (let product of productList) {
    ...
    newProductCard.addEventListener("click", () => {
      ...
      productModal.querySelector("#product-modal-title").textContent =
        product.name;
      productModal.querySelector("#product-modal-price").textContent =
        product.price;
